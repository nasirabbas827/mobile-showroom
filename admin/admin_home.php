...
$totalMobiles = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM mobiles"))['total'];
...
<div class="container mt-5">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Total Mobiles</h5>
                    <p class="card-text"><?php echo $totalMobiles; ?></p>
                </div>
            </div>
        </div>
    </div>
